...
eventType: "personal"
description: "POS + Mini-ERP + Booking público para barbería premium. Registro de ventas en 3 clics, caja chica con auditoría inmutable, inventario con alertas y reservas con Google OAuth."
description_en: "POS + Mini-ERP + public booking for a premium barbershop. 3-click sales, immutable cash register audit, inventory alerts, and reservations with Google OAuth."

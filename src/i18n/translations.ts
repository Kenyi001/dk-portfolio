...
export const ui = {
  es: {
    ...
    'hero.bio': 'Construyo sistemas de IA que corren en producción bancaria: RAG, optimización de tokens y OCR. También desarrollo smart contracts, con premios en hackathons de Cardano y Stellar. Desde Santa Cruz, Bolivia.',
  ...
  en: {
    ...
    'hero.bio': 'I build AI systems running in banking production: RAG, token optimization and OCR. I also build smart contracts, with awards at Cardano and Stellar hackathons. From Santa Cruz, Bolivia.',
